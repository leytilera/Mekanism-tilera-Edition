...
public class GuiWeatherOrb extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 80, this.height / 2 - 65, 50, 20, "Clear"));
        this.buttonList.add(new GuiButton(1, this.width / 2 - 80, this.height / 2 - 35, 50, 20, "Storm"));
        this.buttonList.add(new GuiButton(2, this.width / 2 + 5, this.height / 2 - 65, 50, 20, "Haze"));
        this.buttonList.add(new GuiButton(3, this.width / 2 + 5, this.height / 2 - 35, 50, 20, "Rain"));
    }
    
    @Override
    public void drawScreen(final int i, final int j, final float f) {
        GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
        this.mc.renderEngine.bindTexture(MekanismUtils.getResource(ResourceType.GUI, "GuiWeatherOrb.png"));
        this.drawTexturedModalRect(this.width / 2 - 100, this.height / 2 - 100, 0, 0, xSize, ySize);
        this.drawString(this.fontRendererObj, "Weather Orb", this.width / 2 - 45, this.height / 2 - 95, 16777215);
