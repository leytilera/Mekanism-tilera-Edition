...
public class ItemRenderingHandler implements IItemRenderer {
    ...
    private final RenderBin binRenderer = (RenderBin
    ) TileEntityRendererDispatcher.instance.mapSpecialRenderers.get(TileEntityBin.class);
    private final RenderFluidTank portableTankRenderer
        = (RenderFluidTank) TileEntityRendererDispatcher.instance.mapSpecialRenderers
              .get(TileEntityFluidTank.class);
    private final RenderItem renderItem = (RenderItem
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		else if(BasicType.get(item) == BasicType.INDUCTION_CELL || BasicType.get(item) == BasicType.INDUCTION_PROVIDER)
		{
            ...
            if (binRenderer == null
                || binRenderer.func_147498_b() /*getFontRenderer()*/ == null) {
                return;
            }
            ...
            if (itemStack != null) {
                ...
                if (!(itemStack.getItem() instanceof ItemBlock)
                    || Block.getBlockFromItem(itemStack.getItem()).getRenderType() != 0) {
                ...
                renderItem.renderItemAndEffectIntoGUI(
                    binRenderer.func_147498_b() /*getFontRenderer()*/,
                    renderEngine,
                    itemStack,
                    0,
                    0
            ...
            mc.renderEngine.bindTexture(
                MekanismUtils.getResource(ResourceType.RENDER, "ObsidianTNT.png")
            );
            GL11.glRotatef(180F, 0.0F, 0.0F, 1.0F);
            ...
            mc.renderEngine.bindTexture(
                MekanismUtils.getResource(ResourceType.RENDER, "PersonalChest.png")
            );
            ...
            mc.renderEngine.bindTexture(
                MekanismUtils.getResource(ResourceType.RENDER, "Robit.png")
            );
            robit.render(0.08F);
            GL11.glPopMatrix();
            ...
            mc.renderEngine.bindTexture(
                MekanismUtils.getResource(ResourceType.RENDER, "Jetpack.png")
            );
            ...
            mc.renderEngine.bindTexture(
                MekanismUtils.getResource(ResourceType.RENDER, "ScubaSet.png")
            );
            ...
            mc.renderEngine.bindTexture(
                MekanismUtils.getResource(ResourceType.RENDER, "FreeRunners.png")
            );
            ...
            if (type == ItemRenderType.EQUIPPED
                ...
                balloonRenderer.render(
                    ((ItemBalloon) item.getItem()).getColor(item), 0, 1.9F, 0
                );
            } else {
                balloonRenderer.render(
                    ((ItemBalloon) item.getItem()).getColor(item), 0, 1, 0
                );
            }
            ...
            mc.renderEngine.bindTexture(
                MekanismUtils.getResource(ResourceType.RENDER, "AtomicDisassembler.png")
            );
            ...
            RenderPartTransmitter.getInstance().renderItem(TransmitterType.values(
            )[item.getItemDamage()]);
            ...
            mc.renderEngine.bindTexture(
                MekanismUtils.getResource(ResourceType.RENDER, "Flamethrower.png")
            );
            ...
            Fluid fluid = itemMachine.getFluidStack(item) != null
                ? itemMachine.getFluidStack(item).getFluid()
                : null;
            portableTankRenderer.render(
                tier, fluid, targetScale, false, null, -0.5, -0.5, -0.5
            );
            GL11.glPopMatrix();
        } else {
            if (item.getItem() instanceof ItemBlockMachine) {
                ...
                if (machine == MachineType.BASIC_FACTORY
                    || machine == MachineType.ADVANCED_FACTORY
                    || machine == MachineType.ELITE_FACTORY) {
                    GL11.glRotatef(-90F, 0.0F, 1.0F, 0.0F);
                    MekanismRenderer.renderCustomItem(((RenderBlocks) data[0]), item);
                } else {
